__all__ = ['regulariser', 'regulariser_grid', 'relax', 'relax_grid',
           'precond', 'precond_grid', 'pcg', 'pcg_grid', 'fmg', 'fmg_grid']

from .utils import make_list, vector_to_list, movedim, convert_bound
import torch
...
def regulariser(input, weight=None, hessian=None, dim=None,
...
def regulariser_grid(input, weight=None, hessian=None,
...
def relax(gradient, weight=None, hessian=None, dim=None,
          absolute=0, membrane=0, bending=0, factor=1,
...
def relax_grid(gradient, weight=None, hessian=None,
               absolute=0, membrane=0, bending=0, lame=0, factor=1,
...
def pcg(gradient, weight=None, hessian=None, dim=None,
        absolute=0, membrane=0, bending=0, factor=1,
...
def pcg_grid(gradient, weight=None, hessian=None,
             absolute=0, membrane=0, bending=0, lame=0, factor=1,
...
def fmg(hessian, gradient, weight=None, dim=None,
        absolute=0, membrane=0, bending=0, factor=1,
...
def fmg_grid(hessian, gradient, weight=None,
             absolute=0, membrane=0, bending=0, lame=0, factor=1,
