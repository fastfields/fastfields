...
Tensor regulariser(
  ...
  if (weight.defined() && weight.numel() > 0)
  {
    ...
    FF_CHECK_OPT_SAME_DEVICE(input_opt, weight_opt)
    FF_CHECK_OPT_SAME_DTYPE(input_opt, weight_opt)
  ...
  if (hessian.defined() && hessian.numel() > 0)
  {
    ...
    FF_CHECK_OPT_SAME_DEVICE(input_opt, hessian_opt)
    FF_CHECK_OPT_SAME_DTYPE(input_opt, hessian_opt)
