...
grad(InterpolationType interpolation_type, scalar_t x) {
  switch (interpolation_type) {
    ...
    case InterpolationType::FifthOrder:   return _interpolation::grad5(x);
    case InterpolationType::SixthOrder:   return _interpolation::grad6(x);
    case InterpolationType::SeventhOrder: return _interpolation::grad7(x);
...
fastgrad(InterpolationType interpolation_type, scalar_t x) {
  switch (interpolation_type) {
    ...
    case InterpolationType::FifthOrder:   return _interpolation::fastgrad5(x); 
    case InterpolationType::SixthOrder:   return _interpolation::fastgrad6(x);
    case InterpolationType::SeventhOrder: return _interpolation::fastgrad7(x);
...
hess(InterpolationType interpolation_type, scalar_t x) {
  switch (interpolation_type) {
    ...
    case InterpolationType::Linear:       return _interpolation::hess1(x);
    case InterpolationType::Quadratic:    return _interpolation::hess2(x);
    case InterpolationType::Cubic:        return _interpolation::hess3(x);
    case InterpolationType::FourthOrder:  return _interpolation::hess4(x);
    case InterpolationType::FifthOrder:   return _interpolation::hess0(x); // notimplemented
    case InterpolationType::SixthOrder:   return _interpolation::hess0(x); // notimplemented
    case InterpolationType::SeventhOrder: return _interpolation::hess0(x); // notimplemented
    default:                              return _interpolation::grad1(x);
  }
}
...
fasthess(InterpolationType interpolation_type, scalar_t x) {
  switch (interpolation_type) {
    ...
    case InterpolationType::Linear:       return _interpolation::fasthess1(x);
    case InterpolationType::Quadratic:    return _interpolation::fasthess2(x);
    case InterpolationType::Cubic:        return _interpolation::fasthess3(x);
    case InterpolationType::FourthOrder:  return _interpolation::fasthess4(x);
    case InterpolationType::FifthOrder:   return _interpolation::fasthess0(x); // notimplemented
    case InterpolationType::SixthOrder:   return _interpolation::fasthess0(x); // notimplemented
    case InterpolationType::SeventhOrder: return _interpolation::fasthess0(x); // notimplemented
